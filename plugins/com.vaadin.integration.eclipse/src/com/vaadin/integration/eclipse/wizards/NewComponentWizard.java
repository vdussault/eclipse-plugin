...
public class NewComponentWizard extends Wizard implements INewWizard {
    ...
    private void buildClientSideClass(IProgressMonitor monitor)
        ...
        String widgetSetName = page.getWidgetSetName();
        ...
        try {
            ...
            IPackageFragment packageFragment = widgetSet.getPackageFragment();

            final String packageName = packageFragment.getElementName() + ".ui";
